            ...
            {conversation.messages.length === 0 ? (
              <>
                <div className="flex flex-col mx-auto pt-12 space-y-10 w-[350px] sm:w-[600px]">
                  <div className="text-4xl font-semibold text-center text-gray-800 dark:text-gray-100" >{models.length === 0 ? "ChatGPT" : "ChatGPT"}</div>
                  <div style={{ fontSize: "20px", textAlign: "center" }}>What can I help you? </div>
                  {/* {models.length > 0 && (
